...
OSS_VALID_TIME = CONFIG.OSS_VALID_TIME
OSS_AGREEMENT_FILE_PREFIX = CONFIG.OSS_AGREEMENT_FILE_PREFIX
OSS_EXAM_DOC_PREFIX = CONFIG.OSS_EXAM_DOC_PREFIX
OSS_CONFIRMATION_FILE_PREFIX = CONFIG.OSS_CONFIRMATION_FILE_PREFIX
OSS_SUPERVISOR_PHOTO_PREFIX = CONFIG.OSS_SUPERVISOR_PHOTO_PREFIX
OSS_VENUE_IMAGE_PREFIX = CONFIG.OSS_VENUE_IMAGE_PREFIX
OSS_ROOM_IMAGE_PREFIX = CONFIG.OSS_ROOM_IMAGE_PREFIX
OSS_APPOINTMENT_PREFIX = CONFIG.OSS_APPOINTMENT_PREFIX
OSS_SPLIT_ATTACHMENT_PREFIX = CONFIG.OSS_SPLIT_ATTACHMENT_PREFIX
OSS_FEE_ATTACHMENT_PREFIX = CONFIG.OSS_FEE_ATTACHMENT_PREFIX
OSS_INVENTORY_IMAGE_PREFIX = CONFIG.OSS_INVENTORY_IMAGE_PREFIX
OSS_WAREHOUSE_IMAGE_PREFIX = CONFIG.OSS_WAREHOUSE_IMAGE_PREFIX
OSS_SIGN_IMAGE_PREFIX = CONFIG.OSS_SIGN_IMAGE_PREFIX
OSS_VENUE_LETTER_PREFIX = CONFIG.OSS_VENUE_LETTER_PREFIX
